...
app.on('ready', () => {  
  ...
  const win= new BrowserWindow({frame:true,resizeable:false, x:width-148,y:0,width:250, height:250,useContentSize:true,opacity:0.95, transparent:false, title:'squwbs',appIcon:__dirname + '/static/img/tray_icon.png',titleBarStyle:"default"})
